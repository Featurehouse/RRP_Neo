...
//    @ExpectPlatform
    static Path getGameDir() { return xland.mcmod.remoteresourcepack.neo.RemoteResourcePackImpl.getGameDir(); }
...
//    @ExpectPlatform
    private static Path getConfigDir() { return xland.mcmod.remoteresourcepack.neo.RemoteResourcePackImpl.getConfigDir(); }

    // <mod.jar>/RemoteResourcePack.json
//    @ExpectPlatform
    static Map<String, Path> getModsBuiltinConfigs() { return xland.mcmod.remoteresourcepack.neo.RemoteResourcePackImpl.getModsBuiltinConfigs(); }
